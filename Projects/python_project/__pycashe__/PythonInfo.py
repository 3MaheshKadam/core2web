...
class Ui_C2W_PythonInfoDialog(object):
    ...
    def setupUi(self, Widget):
        ...
        self.c2w_pdf_viewer = PDFViewer('D:\core2web\Projects\python_project\python Intro.pdf')
        layout = QtWidgets.QVBoxLayout(self.c2w_tab)
        layout.addWidget(self.c2w_pdf_viewer)
        self.c2w_pdf_viewer = PDFViewer('D:\core2web\Projects\python_project\python Histroy.pdf')
